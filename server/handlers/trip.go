...
func (h *handlerTrip) CreateTrip(c *gin.Context) {
	...
	if userAdmin {
		...
		c.JSON(http.StatusOK, resultdto.SuccessResult{Status: http.StatusOK, Message: "data sudah ditambah", Data: convertResponseTrip(data)})
...
func (h *handlerTrip) UpdateTrip(c *gin.Context) {
	...
	if userAdmin {
		...
		c.JSON(http.StatusOK, resultdto.SuccessResult{Status: http.StatusOK, Message: "data sudah berhasil di update", Data: convertResponseTrip(data)})
		return
...
func (h *handlerTrip) DeleteTrip(c *gin.Context) {
	...
	if userAdmin {
		...
		c.JSON(http.StatusOK, resultdto.SuccessResult{Status: http.StatusOK, Message: "data sudah berhasil di hapus", Data: convertResponseTrip(data)})
		return
